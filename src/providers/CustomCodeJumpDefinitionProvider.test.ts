...
suite('CustomCodeJumpDefinitionProvider.provideHover()', () => {
  ...
  const TEST_CASES: TestCase[] = [
    ...
    },
    {
      ...
      expected: createLocationByFilePath('/scripts/project/main/logger.ts'),
    },
    {
      title: 'should define path if matched',
      definition: config.definitions[0],
      ...
      expected: createLocationByFilePath('/scripts/project/main/tracking.js'),
    },
    {
      ...
      expected: createLocationByFilePath(
